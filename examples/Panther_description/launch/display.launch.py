"""
Launch file for Panther.

Usage:
    ros2 launch Panther_description display.launch.py
    ros2 launch Panther_description display.launch.py namespace:=robot1
"""
...
def generate_launch_description():
    pkg_dir = get_package_share_directory('Panther_description')

    xacro_file = os.path.join(pkg_dir, 'urdf', 'Panther.urdf.xacro')
